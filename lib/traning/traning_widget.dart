...
class TraningWidget extends StatefulWidget {
  const TraningWidget({Key? key}) : super(key: key);

  @override
  _TraningWidgetState createState() => _TraningWidgetState();
}

class _TraningWidgetState extends State<TraningWidget> {
